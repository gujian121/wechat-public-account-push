export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx8ee3d2193757aea0",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "fe70daf2ffc4f62ecc1573b98e9cf705",
   ...
   */
  USERS: ["oDsKs5xORafgFJG_udE2mNKjYYR0"],["oDsKs597pQ3Y7fYbqrOYu6-FTYoA"]
    {
      // 想要发送的人的名字
      name: "宝宝",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "oDsKs5xORafgFJG_udE2mNKjYYR0",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "-YamxetZ8KypwVkNfccWTg2oeIQG5oSsYXOuIf7NDm8",
      // 所在省份
      province: "江苏",
      // 所在城市
      city: "常州",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "1999", "date": "03-13"},
      ],
